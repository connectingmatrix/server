export declare const PACKAGE_STRUCTURE: {
    readonly package: "connectingmatrix-server";
    ...
    readonly movesApplied: {
        readonly backend: readonly [readonly ["general", "modules/platform"], readonly ["mcp", "modules/mcp"], readonly ["process-monitoring", "modules/monitoring"]];
    ...
    readonly counts: {
        ...
        readonly backend: {
            readonly files: 166;
            readonly bytes: 1019257;
        };
        readonly entity: {
            readonly files: 30;
            readonly bytes: 156800;
        };
        readonly migrations: {
            readonly files: 23;
            readonly bytes: 67409;
        };
        readonly tests: {
            readonly files: 85;
            readonly bytes: 303952;
        };
    };
};
