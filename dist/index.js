...
export function wirePackageRuntime(modules) {
    ...
    const workflows = runtimeOf(byName, '@connectingmatrix/workflow-driver');
    ...
    const gigaAgents = runtimeOf(byName, '@connectingmatrix/agents');
