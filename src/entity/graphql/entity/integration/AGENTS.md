...
- Path: `packages/apps/orm-access/src/services/graphql/entity/integration`
...
- Runtime monitor resolver rule: `runtime-monitor-resolvers.ts` must map ingestion job reads and process stop/kill controls to typed GraphQL payloads with scope enforcement.

## File Usage Specification

### `advanced-agent-os-resolvers.ts`
...
- Key snippets and use-case mapping:
  - `L1-L33`: File-level constants/types behavior.
### `agent-app-live-resolvers.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L66`: File-level constants/types behavior.
### `agent-ui-chat-resolvers.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L24`: File-level constants/types behavior.
### `ai-agent-resolvers.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `createEntityGraphQLLoaders` (L28-L28, arrow)
- Exports:
  - `createEntityGraphQLLoaders` (L28)
- Key snippets and use-case mapping:
  - `L28-L28`: Implements `createEntityGraphQLLoaders` for this module use case.
### `metadata-entity-resolvers.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L49`: File-level constants/types behavior.
### `runtime-monitor-resolvers.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
