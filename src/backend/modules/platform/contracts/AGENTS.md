...
- Path: `packages/apps/general/src/contracts`
...
- Chat ingestion contract rule: `agentIngestPost` and `agentIngestAttachment` must stay non-blocking and return ingestion job handles consumed by process-monitoring APIs.
