...
- Path: `packages/apps/general/src/services/user/lookups/read`
...
- Functions (all):
  - `getAllUsers` (L6-L6, function)
- Exports:
  - `getAllUsers` (L6)
- Key snippets and use-case mapping:
  - `L6-L6`: Implements `getAllUsers` for this module use case.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `getUserByEmail` (L5-L5, function)
- Exports:
  - `getUserByEmail` (L5)
- Key snippets and use-case mapping:
  - `L5-L5`: Implements `getUserByEmail` for this module use case.
### `get-user-by-id.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `getUserById` (L6-L6, function)
- Exports:
  - `getUserById` (L6)
- Key snippets and use-case mapping:
  - `L6-L6`: Implements `getUserById` for this module use case.
### `get-user-by-username.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `getUserByUsername` (L6-L6, function)
- Exports:
  - `getUserByUsername` (L6)
- Key snippets and use-case mapping:
  - `L6-L6`: Implements `getUserByUsername` for this module use case.
### `read-users-by-email.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
- Output shape: Typed return values, thrown errors, and exported contracts declared in this file.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `readUsersByEmail` (L6-L6, function)
- Exports:
  - `readUsersByEmail` (L6)
- Key snippets and use-case mapping:
  - `L6-L6`: Implements `readUsersByEmail` for this module use case.
