...
- Path: `packages/apps/general/src/services/graphql/resolvers/auth`
...
- Key snippets and use-case mapping:
  - `L1-L95`: File-level constants/types behavior.
### `tree-access.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `assertTreeWrite` (L11-L11, function)
  - `requireChannelWrite` (L19-L19, function)
  - `requireCategoryWrite` (L27-L27, function)
  - `requireSubjectWrite` (L35-L35, function)
  - `requirePostWrite` (L43-L43, function)
- Exports:
  - `requireChannelWrite` (L19)
  - `requireCategoryWrite` (L27)
  - `requireSubjectWrite` (L35)
  - `requirePostWrite` (L43)
- Key snippets and use-case mapping:
  - `L11-L11`: Implements `assertTreeWrite` for this module use case.
  - `L19-L19`: Implements `requireChannelWrite` for this module use case.
  - `L27-L27`: Implements `requireCategoryWrite` for this module use case.
  - `L35-L35`: Implements `requireSubjectWrite` for this module use case.
  - `L43-L43`: Implements `requirePostWrite` for this module use case.
