...
- Path: `packages/apps/general/src/services/credentials/telemetry`
...
- Functions (all):
  - `formatLabel` (L3-L3, function)
  - `parseEnumOptions` (L11-L11, function)
  - `parseInputKind` (L24-L24, function)
  - `parseCredentialCatalogField` (L38-L38, function)
- Exports:
  - `parseCredentialCatalogField` (L38)
- Key snippets and use-case mapping:
  - `L3-L3`: Implements `formatLabel` for this module use case.
  - `L11-L11`: Implements `parseEnumOptions` for this module use case.
  - `L24-L24`: Implements `parseInputKind` for this module use case.
  - `L38-L38`: Implements `parseCredentialCatalogField` for this module use case.
### `catalog.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `listCredentialCatalog` (L35-L35, function)
  - `getCredentialCatalogService` (L39-L39, function)
  - `getCredentialCatalogPayload` (L43-L43, function)
- Exports:
  - `listCredentialCatalog` (L35)
  - `getCredentialCatalogService` (L39)
  - `getCredentialCatalogPayload` (L43)
- Key snippets and use-case mapping:
  - `L35-L35`: Implements `listCredentialCatalog` for this module use case.
  - `L39-L39`: Implements `getCredentialCatalogService` for this module use case.
  - `L43-L43`: Implements `getCredentialCatalogPayload` for this module use case.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `recordCredentialExecutionResult` (L8-L8, function)
- Exports:
  - `recordCredentialExecutionResult` (L8)
- Key snippets and use-case mapping:
  - `L8-L8`: Implements `recordCredentialExecutionResult` for this module use case.
