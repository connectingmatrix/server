...
- Path: `packages/apps/general/src/services/credentials/auth`
...
- Functions (all):
  - `deny` (L18-L18, function)
  - `readOrganizationId` (L22-L22, function)
  - `buildCredentialAccess` (L27-L27, function)
  - `resolveCredentialAccess` (L85-L85, function)
  - `resolveRuntimeCredentialAccess` (L111-L111, function)
  - `assertCredentialQueryAllowed` (L136-L136, function)
  - `assertCredentialMutationAllowed` (L142-L142, function)
  - `assertCredentialExecutionAllowed` (L151-L151, function)
- Exports:
  - `resolveCredentialAccess` (L85)
  - `resolveRuntimeCredentialAccess` (L111)
  - `assertCredentialQueryAllowed` (L136)
  - `assertCredentialMutationAllowed` (L142)
  - `assertCredentialExecutionAllowed` (L151)
- Key snippets and use-case mapping:
  - `L18-L18`: Implements `deny` for this module use case.
  - `L22-L22`: Implements `readOrganizationId` for this module use case.
  - `L27-L27`: Implements `buildCredentialAccess` for this module use case.
  - `L85-L85`: Implements `resolveCredentialAccess` for this module use case.
  - `L111-L111`: Implements `resolveRuntimeCredentialAccess` for this module use case.
  - `L136-L136`: Implements `assertCredentialQueryAllowed` for this module use case.
  - `L142-L142`: Implements `assertCredentialMutationAllowed` for this module use case.
  - `L151-L151`: Implements `assertCredentialExecutionAllowed` for this module use case.
