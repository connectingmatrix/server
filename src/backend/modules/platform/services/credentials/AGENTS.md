...
- Path: `packages/apps/general/src/services/credentials`
...
- Exports:
  - `listCredentialCatalog` (L12)
  - `getCredentialCatalogService` (L12)
  - `recordCredentialExecutionResult` (L13)
- Key snippets and use-case mapping:
  - `L1-L22`: File-level constants/types behavior.
