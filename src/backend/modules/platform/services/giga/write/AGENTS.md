...
- Path: `packages/apps/general/src/services/giga/write`
...
- Functions (all):
  - `deleteOrganizationTree` (L15-L15, function)
- Exports:
  - `deleteOrganizationTree` (L15)
- Key snippets and use-case mapping:
  - `L15-L15`: Implements `deleteOrganizationTree` for this module use case.
