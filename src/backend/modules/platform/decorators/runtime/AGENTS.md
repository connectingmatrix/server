...
- Path: `packages/apps/general/src/decorators/runtime`
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `transientAttempts` (L8-L8, arrow)
  - `transientDelayMs` (L9-L9, arrow)
  - `isTransientNeo4jError` (L14-L14, arrow)
  - `isExistingIndexError` (L18-L18, arrow)
  - `wait` (L20-L20, arrow)
  - `Neo4JConnection` (L59-L59, class)
  - `resetActiveInstance` (L105-L105, method)
- Exports:
  - `Neo4JConnection` (L59)
- Key snippets and use-case mapping:
  - `L8-L8`: Implements `transientAttempts` for this module use case.
  - `L9-L9`: Implements `transientDelayMs` for this module use case.
  - `L14-L14`: Implements `isTransientNeo4jError` for this module use case.
  - `L18-L18`: Implements `isExistingIndexError` for this module use case.
  - `L20-L20`: Implements `wait` for this module use case.
  - `L59-L59`: Implements `Neo4JConnection` for this module use case.
  - `L105-L105`: Implements `resetActiveInstance` for this module use case.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `InjectSupabase` (L14-L14, function)
  - `InjectSupabaseAdmin` (L22-L22, function)
  - `InjectSupabaseService` (L31-L31, function)
  - `InjectSupabaseAdminService` (L36-L36, function)
- Exports:
  - `InjectSupabase` (L14)
  - `InjectSupabaseAdmin` (L22)
  - `InjectSupabaseService` (L31)
  - `InjectSupabaseAdminService` (L36)
- Key snippets and use-case mapping:
  - `L14-L14`: Implements `InjectSupabase` for this module use case.
  - `L22-L22`: Implements `InjectSupabaseAdmin` for this module use case.
  - `L31-L31`: Implements `InjectSupabaseService` for this module use case.
  - `L36-L36`: Implements `InjectSupabaseAdminService` for this module use case.
