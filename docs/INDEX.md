# @connectingmatrix/server package index

## Ownership

Package composition, middleware/API registration, GraphQL manifest merge, MCP/status generation.
...
{
  "dependencies": {
    "@connectingmatrix/server": "file:../packages/server"
  }
}
```
